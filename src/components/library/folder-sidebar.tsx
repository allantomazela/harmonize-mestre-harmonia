...
export function FolderSidebar({
  ...
  return (
    <div className="w-full md:w-72 flex flex-col gap-4 h-full border-r border-border pr-4">
      <Tabs defaultValue="folders" className="h-full flex flex-col">
        <TabsList className="w-full grid grid-cols-2">
          <TabsTrigger value="folders">
            <FolderIcon className="w-4 h-4 mr-2" /> Pastas
          </TabsTrigger>
        ...
        <TabsContent
          value="folders"
          className="flex-1 flex flex-col gap-4 mt-4 h-full overflow-hidden"
        >
          <div className="flex items-center justify-between">
            <h3 className="font-semibold text-lg">Suas Pastas</h3>
            <Button
              variant="ghost"
              size="icon"
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Isso excluirá a pasta "{folder.name}". As músicas
                          contidas nela não serão apagadas.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
        ...
        <TabsContent
          value="filters"
          className="flex-1 mt-4 h-full overflow-hidden"
        >
          <LibraryFilters
            tracks={tracks}
